...
local mainOptions = {
	...
	args = {
		...
		Changelog_Tab = {
			...
			args = {
				releaseText = {
					name = C_AddOns.GetAddOnMetadata(addonName, "Version"),
					order = 1,
					type = "description",
					fontSize = "large",
				},
				...
				fixedText = {
					...
					coloredDash .. "Fixed an issue with the wrong function being called when determining the player's map position.",
					order = 31,
					type = "description",
					fontSize = "medium",
				},
