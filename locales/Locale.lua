...
tbl.SetLocale = function(locale)
	...
	if locale == "enUS" then
		tbl.L = {
			...
			["DATE"]									= date("%m/%d/%Y");
			["DEBUG"] 									= "Debug";
			["DESCRIPTION_COMMAND_FORMAT"]				= "Allows the player to change the format of dates in the items table. D/M/Y or M/D/Y.";
			["DESCRIPTION_COMMAND_HELP"]				= "Lists out the commands of the addon.";
			["DESCRIPTION_COMMAND_HISTORY"]				= "Provides a list of the last 20 items the addon saw, persistent between sessions.";
			["DESCRIPTION_COMMAND_LOCALE"]				= "Changes the current locale of the addon.";
			["DESCRIPTION_COMMAND_LOOT"]				= "Enables or disables a quick loot setting. This may or may not impact performance.";
			["DESCRIPTION_COMMAND_MAN"]					= "A handbook with information about other commands.";
			["DESCRIPTION_COMMAND_REMOVE"]				= "Deletes an item from the items table. Accepts both ID and links.\nAliases: rm";
			["DESCRIPTION_COMMAND_SEARCH"]				= "Finds an item in the items table and returns the results to the player. Accepts ID, links, and partial names.";
			["DESCRIPTION_COMMAND_VIEW"]				= "Used to view items that were automatically removed from the items table.";
